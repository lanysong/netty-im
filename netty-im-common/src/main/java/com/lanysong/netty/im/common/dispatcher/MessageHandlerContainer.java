...
public class MessageHandlerContainer implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		...
		applicationContext.getBeansOfType(MessageHandler.class).values().forEach(messageHandler -> handlers.put(messageHandler.getType(),messageHandler));
	...
	static Class<? extends Message> getMessageClass(MessageHandler handler){
		// 获得bean 对应 Class 类名。因为有可能被 Aop 代理过
		...
		while (CollectionUtils.isEmpty(Arrays.asList(interfaces)) && Objects.nonNull(superclass)){
			// 此处，是以父类的接口为准
